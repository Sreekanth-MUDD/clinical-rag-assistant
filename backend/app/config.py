...
class Settings(BaseSettings):
    DATABASE_URL: str = "postgresql+asyncpg://***REMOVED***:***REMOVED***@localhost:5432/***REMOVED***"
    DATABASE_SYNC_URL: str = "postgresql+psycopg://***REMOVED***:***REMOVED***@localhost:5432/***REMOVED***"
